...
=======
      // Add ₹20 to wallet (simulate Razorpay payment received), then pay for ride
      await topupWallet(20);
      const result = await payForRide(bus.id);
      onSuccess({
...
=======
          <button className="btn btn-ghost" style={{ padding: '4px 8px', fontSize: 18 }} onClick={onClose}>
            ×
          </button>
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 12, color: '#52796F', marginBottom: 4 }}>Paying to</div>
          <div style={{ fontWeight: 700, fontSize: 15 }}>Bus-Share Transit</div>
          <div style={{ fontSize: 12, color: '#84A98C', marginTop: 2 }}>
...
=======
        ...
        {step === 'review' && (
          <div style={{ marginBottom: 20 }}>
            <div style={{ fontSize: 11, color: '#52796F', marginBottom: 10, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
              Payment Method
            </div>
            <div style={{
        ...
        {step === 'review' && (
          <button className="btn btn-primary w-full" style={{ fontSize: 15, padding: '13px' }} onClick={handlePay}>
            Pay ₹20 →
          </button>
>>>>>>> a4055be (V2.1.1 : Fronted changes)
        )}
